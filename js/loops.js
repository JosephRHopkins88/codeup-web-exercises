// var multiplyItself = 2;
// while (multiplyItself <= 65536) {
//     console.log(multiplyItself);
//     multiplyItself = multiplyItself * 2;
// }
...
//
// do {
//     console.log("There are currently " + allCones + " left for purchase.");
