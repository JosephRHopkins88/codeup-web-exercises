// Cheat Codes
neededkeys = [38,38,40,40,37,39,37,39,66,65,13], started = false, count = 0;
$(document).keydown(function(e) {
    ...
    if (started) {
        ...
        if (count === 11) {
            reset();
            // Do your stuff here
            alert('CAUTION: Adjust volume before proceeding please.');
            $('body').css('background-color', 'black');
            $('h1').css({ 'color': 'red', 'font-size': '200px' });
            ...
            (function() {
                ...
                var animationCSS = {
                    ...
                    'konamiCode': function() {
                        ...
                        return 'konamiCode' + key + ' 8s infinite ease-in-out'
                    }
                }
                ...
                function embedVideo() {
                    ...
                    parent.style.webkitTransition = 'opacity 0 ease-in-out'
                    parent.style.transition = 'opacity 0 ease-in-out'
                ...
                function setupAnimations() {
                    ...
                    for(var i = 0; i < turntKeyFrames.length; i++) {
                        ...
                        allStyles += '@-webkit-keyframes konamiCode' + i + ' { ' + kf + ' } '
                        allStyles += '@keyframes konamiCode' + i + ' { ' + kf + ' } '
                    }
